...
<head>
    ...
    <title>Wedding &mdash; Youngboycodon</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Youngboycodon" />
    <meta name="keywords" content="Youngboycodon" />
    <meta name="author" content="Youngboycodon" />
    ...
    <!-- Modernizr JS -->
    <script src="{{ asset('web/assets/js/modernizr-2.6.2.min.js') }}"></script>
    <!-- FOR IE9 below -->
    <!--[if lt IE 9]>
...
<body>
    ...
    <div id="page">
        ...
        <header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url({{ asset('web/assets/images/img_bg_2.jpg') }});"
                    ...
                    <div class="col-md-8 col-md-offset-2 text-center">
                        <div class="display-t">
                            <div class="display-tc animate-box" data-animate-effect="fadeIn">
                                <h1>Tuan Hip &amp; Ngo</h1>
                                <h2>Cùng ăn mừng chúng tôi kết hôn</h2>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
                        <h2>Thân mời!</h2>
                        <h3>Ngày 31 tháng 12 2024, Thái Bình</h3>
                ...
                <div class="couple-wrap animate-box">
                    <div class="couple-half">
                        <div class="groom">
                            <img src="{{ asset('web/assets/images/groom.jpg') }}" alt="groom" class="img-responsive">
                        </div>
                        <div class="desc-groom">
                            <h3>Tuan Hiep</h3>
                            <p>23 tuổi, developer backend php laravel, Tại vì sao - Youngboycodon</p>
                        </div>
                    </div>
                    <p class="heart text-center"><i class="icon-heart2"></i></p>
                    <div class="couple-half">
                        <div class="bride">
                            <img src="{{ asset('web/assets/images/bride.jpg') }}" alt="groom" class="img-responsive">
                        </div>
                        <div class="desc-bride">
                            <h3>Nga Ngo</h3>
                            <p>18 tuổi, đam mê từ lâu đã chảy trong máu, tuổi trẻ hết mình với cái gọi là đam mê,
                                tại vì sao - Younggirlcodon</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row copyright">
                    <div class="col-md-12 text-center">
                        <p>
                            <small class="block">&copy; 2023 NguyenTuanHiep</small>
                            <small class="block">Made by <a href="https://www.facebook.com/hiepnt102"
                                    target="_blank">NguyenTuanHiep</a> Demo Images: <a href="http://unsplash.co/"
                                    target="_blank">Unsplash</a></small>
                        </p>
                        <p>
                        <ul class="fh5co-social-icons">
                            {{-- <li><a href="#"><i class="icon-twitter"></i></a></li> --}}
                            <li><a href="https://www.facebook.com/hiepnt102"><i class="icon-facebook"></i></a></li>
    ...
    <!-- jQuery Easing -->
    <script src="{{ asset('web/assets/js/jquery.easing.1.3.js') }}"></script>
    <!-- Bootstrap -->
    ...
    <!-- Stellar -->
    <script src="{{ asset('web/assets/js/jquery.stellar.min.js') }}"></script>
    <!-- Magnific Popup -->
    <script src="{{ asset('web/assets/js/jquery.magnific-popup.min.js') }}"></script>
    <script src="{{ asset('web/assets/js/magnific-popup-options.js') }}"></script>

    <!-- // <script src="https://cdnjs.cloudflare.com/ajax/libs/prism/0.0.1/prism.min.js"></script> -->
    <script src="{{ asset('web/assets/js/simplyCountdown.js') }}"></script>
    <!-- Main -->
