        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Thêm mới khách hàng </h4><br><br>
                            <form method="post" action="{{ route('customer.store') }}" id="myForm" enctype="multipart/form-data">
                                ...
                                <!-- end row -->
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Địa chỉ
                                    </label>
                                    <div class="form-group col-sm-10">
                                ...
                                <!-- end row -->
                                <input type="submit" class="btn btn-info waves-effect waves-light" value="Thêm khách hàng">
                            </form>
                        </div>
                    </div>
                </div> <!-- end col -->
